...
public struct CoreML_Specification_MILSpec_Program {
    ...
    var functions: [String: CoreML_Specification_MILSpec_Function] = [:]

    var docString: String = .init()

    /// Any other attributes not described by other fields.
    /// Keys must be valid identifiers as described above.
    var attributes: [String: CoreML_Specification_MILSpec_Value] = [:]
...
public struct CoreML_Specification_MILSpec_Function {
    ...
    var blockSpecializations: [String: CoreML_Specification_MILSpec_Block] = [:]
...
public struct CoreML_Specification_MILSpec_Argument {
    ...
    struct Binding {
        ...
        var binding: CoreML_Specification_MILSpec_Argument.Binding.OneOf_Binding?

        /// The name of a previously defined value.
        var name: String {
            get {
                if case let .name(v)? = binding { return v }
                return String()
            }
        ...
        var value: CoreML_Specification_MILSpec_Value {
            get {
                if case let .value(v)? = binding { return v }
...
public struct CoreML_Specification_MILSpec_Operation {
    ...
    var inputs: [String: CoreML_Specification_MILSpec_Argument] = [:]
...
public struct CoreML_Specification_MILSpec_ValueType {
    ...
    var tensorType: CoreML_Specification_MILSpec_TensorType {
        get {
            if case let .tensorType(v)? = _storage._type { return v }
    ...
    var listType: CoreML_Specification_MILSpec_ListType {
        get {
            if case let .listType(v)? = _storage._type { return v }
    ...
    var tupleType: CoreML_Specification_MILSpec_TupleType {
        get {
            if case let .tupleType(v)? = _storage._type { return v }
    ...
    var dictionaryType: CoreML_Specification_MILSpec_DictionaryType {
        get {
            if case let .dictionaryType(v)? = _storage._type { return v }
        ...
        case dictionaryType(CoreML_Specification_MILSpec_DictionaryType)
            ...
            static func == (lhs: CoreML_Specification_MILSpec_ValueType.OneOf_Type, rhs: CoreML_Specification_MILSpec_ValueType.OneOf_Type) -> Bool {
                ...
                case (.tensorType, .tensorType): return {
                        guard case let .tensorType(l) = lhs, case let .tensorType(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.listType, .listType): return {
                        guard case let .listType(l) = lhs, case let .listType(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.tupleType, .tupleType): return {
                        guard case let .tupleType(l) = lhs, case let .tupleType(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
...
public struct CoreML_Specification_MILSpec_Dimension {
    ...
    var dimension: CoreML_Specification_MILSpec_Dimension.OneOf_Dimension?

    var constant: CoreML_Specification_MILSpec_Dimension.ConstantDimension {
        get {
            if case let .constant(v)? = dimension { return v }
    ...
    var unknown: CoreML_Specification_MILSpec_Dimension.UnknownDimension {
        get {
            if case let .unknown(v)? = dimension { return v }
        ...
        case unknown(CoreML_Specification_MILSpec_Dimension.UnknownDimension)
            ...
            static func == (lhs: CoreML_Specification_MILSpec_Dimension.OneOf_Dimension, rhs: CoreML_Specification_MILSpec_Dimension.OneOf_Dimension) -> Bool {
                ...
                case (.constant, .constant): return {
                        guard case let .constant(l) = lhs, case let .constant(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.unknown, .unknown): return {
                        guard case let .unknown(l) = lhs, case let .unknown(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                default: return false
                }
...
public struct CoreML_Specification_MILSpec_Value {
    ...
    var value: CoreML_Specification_MILSpec_Value.OneOf_Value?

    var immediateValue: CoreML_Specification_MILSpec_Value.ImmediateValue {
        get {
            if case let .immediateValue(v)? = value { return v }
    ...
    var blobFileValue: CoreML_Specification_MILSpec_Value.BlobFileValue {
        get {
            if case let .blobFileValue(v)? = value { return v }
        ...
        case blobFileValue(CoreML_Specification_MILSpec_Value.BlobFileValue)
            ...
            static func == (lhs: CoreML_Specification_MILSpec_Value.OneOf_Value, rhs: CoreML_Specification_MILSpec_Value.OneOf_Value) -> Bool {
                ...
                case (.immediateValue, .immediateValue): return {
                        guard case let .immediateValue(l) = lhs, case let .immediateValue(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.blobFileValue, .blobFileValue): return {
                        guard case let .blobFileValue(l) = lhs, case let .blobFileValue(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                default: return false
                }
    ...
    struct ImmediateValue {
        ...
        var value: CoreML_Specification_MILSpec_Value.ImmediateValue.OneOf_Value?

        var tensor: CoreML_Specification_MILSpec_TensorValue {
            get {
                if case let .tensor(v)? = value { return v }
        ...
        var list: CoreML_Specification_MILSpec_ListValue {
            get {
                if case let .list(v)? = value { return v }
            ...
            case dictionary(CoreML_Specification_MILSpec_DictionaryValue)
                ...
                static func == (lhs: CoreML_Specification_MILSpec_Value.ImmediateValue.OneOf_Value, rhs: CoreML_Specification_MILSpec_Value.ImmediateValue.OneOf_Value) -> Bool {
                    ...
                    case (.tensor, .tensor): return {
                            guard case let .tensor(l) = lhs, case let .tensor(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    case (.tuple, .tuple): return {
                            guard case let .tuple(l) = lhs, case let .tuple(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    case (.list, .list): return {
                            guard case let .list(l) = lhs, case let .list(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    case (.dictionary, .dictionary): return {
                            guard case let .dictionary(l) = lhs, case let .dictionary(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    default: return false
                    }
...
public struct CoreML_Specification_MILSpec_TensorValue {
    ...
    var value: CoreML_Specification_MILSpec_TensorValue.OneOf_Value?

    var floats: CoreML_Specification_MILSpec_TensorValue.RepeatedFloats {
        get {
            if case let .floats(v)? = value { return v }
    ...
    var ints: CoreML_Specification_MILSpec_TensorValue.RepeatedInts {
        get {
            if case let .ints(v)? = value { return v }
    ...
    var bools: CoreML_Specification_MILSpec_TensorValue.RepeatedBools {
        get {
            if case let .bools(v)? = value { return v }
    ...
    var strings: CoreML_Specification_MILSpec_TensorValue.RepeatedStrings {
        get {
            if case let .strings(v)? = value { return v }
    ...
    var longInts: CoreML_Specification_MILSpec_TensorValue.RepeatedLongInts {
        get {
            if case let .longInts(v)? = value { return v }
    ...
    var doubles: CoreML_Specification_MILSpec_TensorValue.RepeatedDoubles {
        get {
            if case let .doubles(v)? = value { return v }
    ...
    var bytes: CoreML_Specification_MILSpec_TensorValue.RepeatedBytes {
        get {
            if case let .bytes(v)? = value { return v }
        ...
        case bytes(CoreML_Specification_MILSpec_TensorValue.RepeatedBytes)
            ...
            static func == (lhs: CoreML_Specification_MILSpec_TensorValue.OneOf_Value, rhs: CoreML_Specification_MILSpec_TensorValue.OneOf_Value) -> Bool {
                ...
                case (.floats, .floats): return {
                        guard case let .floats(l) = lhs, case let .floats(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.ints, .ints): return {
                        guard case let .ints(l) = lhs, case let .ints(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.bools, .bools): return {
                        guard case let .bools(l) = lhs, case let .bools(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.strings, .strings): return {
                        guard case let .strings(l) = lhs, case let .strings(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.longInts, .longInts): return {
                        guard case let .longInts(l) = lhs, case let .longInts(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.doubles, .doubles): return {
                        guard case let .doubles(l) = lhs, case let .doubles(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
...
public struct CoreML_Specification_MILSpec_DictionaryValue {
    ...
    struct KeyValuePair {
        ...
        fileprivate var _key: CoreML_Specification_MILSpec_Value?
        fileprivate var _value: CoreML_Specification_MILSpec_Value?
    }
...
private let _protobuf_package = "CoreML.Specification.MILSpec"
...
extension CoreML_Specification_MILSpec_Program: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularInt64Field(value: &version)
            ...
            case 3: try try decoder.decodeSingularStringField(value: &docString)
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if version != 0 {
            try visitor.visitSingularInt64Field(value: version, fieldNumber: 1)
        }
        if !functions.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Function>.self, value: functions, fieldNumber: 2)
        }
        if !docString.isEmpty {
            try visitor.visitSingularStringField(value: docString, fieldNumber: 3)
        }
        if !attributes.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Value>.self, value: attributes, fieldNumber: 4)
        }
...
extension CoreML_Specification_MILSpec_Function: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &inputs)
            case 2: try try decoder.decodeSingularStringField(value: &opset)
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !opset.isEmpty {
            try visitor.visitSingularStringField(value: opset, fieldNumber: 2)
        }
        if !blockSpecializations.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Block>.self, value: blockSpecializations, fieldNumber: 3)
        }
        if !attributes.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Value>.self, value: attributes, fieldNumber: 4)
        }
...
extension CoreML_Specification_MILSpec_Block: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &inputs)
            case 2: try try decoder.decodeRepeatedStringField(value: &outputs)
            case 3: try try decoder.decodeRepeatedMessageField(value: &operations)
            case 4: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Value>.self, value: &self.attributes) }()
            default: break
            }
        }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !outputs.isEmpty {
            try visitor.visitRepeatedStringField(value: outputs, fieldNumber: 2)
        }
        if !operations.isEmpty {
            try visitor.visitRepeatedMessageField(value: operations, fieldNumber: 3)
        }
        if !attributes.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Value>.self, value: attributes, fieldNumber: 4)
        }
...
extension CoreML_Specification_MILSpec_Argument: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &arguments)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !arguments.isEmpty {
            try visitor.visitRepeatedMessageField(value: arguments, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_Argument.Binding: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        switch binding {
        case .name?: try {
                guard case let .name(v)? = self.binding else { preconditionFailure() }
                try visitor.visitSingularStringField(value: v, fieldNumber: 1)
            }()
        case .value?: try {
                guard case let .value(v)? = self.binding else { preconditionFailure() }
...
extension CoreML_Specification_MILSpec_Operation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 3: try try decoder.decodeRepeatedMessageField(value: &outputs)
            case 4: try try decoder.decodeRepeatedMessageField(value: &blocks)
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !inputs.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Argument>.self, value: inputs, fieldNumber: 2)
        }
        if !outputs.isEmpty {
            try visitor.visitRepeatedMessageField(value: outputs, fieldNumber: 3)
        }
        if !blocks.isEmpty {
            try visitor.visitRepeatedMessageField(value: blocks, fieldNumber: 4)
        }
        if !attributes.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Value>.self, value: attributes, fieldNumber: 5)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_NamedValueType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 2: try try decoder.decodeSingularMessageField(value: &_type)
            default: break
            }
        }
    }
...
extension CoreML_Specification_MILSpec_ValueType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
            ...
            while let fieldNumber = try decoder.nextFieldNumber() {
                ...
                case 1: try {
                        ...
                        if let current = _storage._type {
                            hadOneofValue = true
                            if case let .tensorType(m) = current { v = m }
                        }
                        try decoder.decodeSingularMessageField(value: &v)
                        if let v = v {
                            if hadOneofValue { try decoder.handleConflictingOneOf() }
                ...
                case 2: try {
                        ...
                        if let current = _storage._type {
                            hadOneofValue = true
                            if case let .listType(m) = current { v = m }
                        }
                        try decoder.decodeSingularMessageField(value: &v)
                        if let v = v {
                            if hadOneofValue { try decoder.handleConflictingOneOf() }
                ...
                case 3: try {
                        ...
                        if let current = _storage._type {
                            hadOneofValue = true
                            if case let .tupleType(m) = current { v = m }
                        }
                        try decoder.decodeSingularMessageField(value: &v)
                        if let v = v {
                            if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
            ...
            case .tensorType?: try {
                    guard case let .tensorType(v)? = _storage._type else { preconditionFailure() }
                    try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
                }()
            case .listType?: try {
                    guard case let .listType(v)? = _storage._type else { preconditionFailure() }
                    try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
                }()
            case .tupleType?: try {
                    guard case let .tupleType(v)? = _storage._type else { preconditionFailure() }
                    try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
                }()
            case .dictionaryType?: try {
                    guard case let .dictionaryType(v)? = _storage._type else { preconditionFailure() }
...
extension CoreML_Specification_MILSpec_TensorType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularEnumField(value: &dataType)
            case 2: try try decoder.decodeSingularInt64Field(value: &rank)
            case 3: try try decoder.decodeRepeatedMessageField(value: &dimensions)
            case 4: try { try decoder.decodeMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Value>.self, value: &self.attributes) }()
            default: break
            }
        }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if dataType != .unusedType {
            try visitor.visitSingularEnumField(value: dataType, fieldNumber: 1)
        }
        if rank != 0 {
            try visitor.visitSingularInt64Field(value: rank, fieldNumber: 2)
        }
        if !dimensions.isEmpty {
            try visitor.visitRepeatedMessageField(value: dimensions, fieldNumber: 3)
        }
        if !attributes.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_MILSpec_Value>.self, value: attributes, fieldNumber: 4)
        }
...
extension CoreML_Specification_MILSpec_TupleType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &types)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !types.isEmpty {
            try visitor.visitRepeatedMessageField(value: types, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_ListType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    fileprivate class _StorageClass {
        var _type: CoreML_Specification_MILSpec_ValueType?
        var _length: CoreML_Specification_MILSpec_Dimension?
...
extension CoreML_Specification_MILSpec_DictionaryType: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    fileprivate class _StorageClass {
        var _keyType: CoreML_Specification_MILSpec_ValueType?
        var _valueType: CoreML_Specification_MILSpec_ValueType?
...
extension CoreML_Specification_MILSpec_Dimension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 1: try {
                    ...
                    if let current = self.dimension {
                        hadOneofValue = true
                        if case let .constant(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        switch dimension {
        case .constant?: try {
                guard case let .constant(v)? = self.dimension else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
            }()
        case .unknown?: try {
                guard case let .unknown(v)? = self.dimension else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
            }()
        case nil: break
        }
...
extension CoreML_Specification_MILSpec_Dimension.ConstantDimension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularUInt64Field(value: &size)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if size != 0 {
            try visitor.visitSingularUInt64Field(value: size, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_Dimension.UnknownDimension: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularBoolField(value: &variadic)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if variadic != false {
            try visitor.visitSingularBoolField(value: variadic, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_Value: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularStringField(value: &docString)
            case 2: try try decoder.decodeSingularMessageField(value: &_type)
            case 3: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .immediateValue(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 5: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .blobFileValue(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        // https://github.com/apple/swift-protobuf/issues/1182
        if !docString.isEmpty {
            try visitor.visitSingularStringField(value: docString, fieldNumber: 1)
        }
        try { if let v = self._type {
            try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
        } }()
        ...
        case .immediateValue?: try {
                guard case let .immediateValue(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
            }()
        case .blobFileValue?: try {
                guard case let .blobFileValue(v)? = self.value else { preconditionFailure() }
...
extension CoreML_Specification_MILSpec_Value.ImmediateValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 1: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .tensor(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 2: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .tuple(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 3: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .list(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 4: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .dictionary(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        switch value {
        case .tensor?: try {
                guard case let .tensor(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
            }()
        case .tuple?: try {
                guard case let .tuple(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
            }()
        case .list?: try {
                guard case let .list(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
            }()
        case .dictionary?: try {
                guard case let .dictionary(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
            }()
        case nil: break
        }
...
extension CoreML_Specification_MILSpec_Value.BlobFileValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularStringField(value: &fileName)
            case 2: try try decoder.decodeSingularUInt64Field(value: &offset)
            default: break
            }
        }
    }
...
extension CoreML_Specification_MILSpec_TensorValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 1: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .floats(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 2: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .ints(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 3: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .bools(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 4: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .strings(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 5: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .longInts(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 6: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .doubles(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 7: try {
                    ...
                    if let current = self.value {
                        hadOneofValue = true
                        if case let .bytes(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        switch value {
        case .floats?: try {
                guard case let .floats(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
            }()
        case .ints?: try {
                guard case let .ints(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
            }()
        case .bools?: try {
                guard case let .bools(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 3)
            }()
        case .strings?: try {
                guard case let .strings(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
            }()
        case .longInts?: try {
                guard case let .longInts(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
            }()
        case .doubles?: try {
                guard case let .doubles(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
            }()
        case .bytes?: try {
                guard case let .bytes(v)? = self.value else { preconditionFailure() }
...
extension CoreML_Specification_MILSpec_TensorValue.RepeatedFloats: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedFloatField(value: &values)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !values.isEmpty {
            try visitor.visitPackedFloatField(value: values, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_TensorValue.RepeatedDoubles: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedDoubleField(value: &values)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !values.isEmpty {
            try visitor.visitPackedDoubleField(value: values, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_TensorValue.RepeatedInts: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedInt32Field(value: &values)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !values.isEmpty {
            try visitor.visitPackedInt32Field(value: values, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_TensorValue.RepeatedBools: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedBoolField(value: &values)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !values.isEmpty {
            try visitor.visitPackedBoolField(value: values, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_TensorValue.RepeatedStrings: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedStringField(value: &values)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !values.isEmpty {
            try visitor.visitRepeatedStringField(value: values, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_TensorValue.RepeatedBytes: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularBytesField(value: &values)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !values.isEmpty {
            try visitor.visitSingularBytesField(value: values, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_MILSpec_TupleValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &values)
            default: break
            }
        }
    }
...
extension CoreML_Specification_MILSpec_DictionaryValue.KeyValuePair: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 2: try try decoder.decodeSingularMessageField(value: &_value)
            default: break
            }
        }
    }

...
public struct CoreML_Specification_NonMaximumSuppression {
    ...
    var suppressionMethod: CoreML_Specification_NonMaximumSuppression.OneOf_SuppressionMethod?

    var pickTop: CoreML_Specification_NonMaximumSuppression.PickTop {
        get {
            if case let .pickTop(v)? = suppressionMethod { return v }
    ...
    var classLabels: CoreML_Specification_NonMaximumSuppression.OneOf_ClassLabels?
    ...
    var confidenceInputFeatureName: String = .init()
    ...
    ///
    /// Specifying shape is optional.
    var coordinatesInputFeatureName: String = .init()
    ...
    var iouThresholdInputFeatureName: String = .init()
    ...
    var confidenceThresholdInputFeatureName: String = .init()
    ...
    /// and upperbound.
    var confidenceOutputFeatureName: String = .init()
    ...
    var coordinatesOutputFeatureName: String = .init()
        ...
        case pickTop(CoreML_Specification_NonMaximumSuppression.PickTop)
            ...
            static func == (lhs: CoreML_Specification_NonMaximumSuppression.OneOf_SuppressionMethod, rhs: CoreML_Specification_NonMaximumSuppression.OneOf_SuppressionMethod) -> Bool {
                ...
                case (.pickTop, .pickTop): return {
                        guard case let .pickTop(l) = lhs, case let .pickTop(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                }
            }
...
extension CoreML_Specification_NonMaximumSuppression: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 1: try {
                    ...
                    if let current = self.suppressionMethod {
                        hadOneofValue = true
                        if case let .pickTop(m) = current { v = m }
                    }
            ...
            case 110: try try decoder.decodeSingularDoubleField(value: &iouThreshold)
            case 111: try try decoder.decodeSingularDoubleField(value: &confidenceThreshold)
            case 200: try try decoder.decodeSingularStringField(value: &confidenceInputFeatureName)
            case 201: try try decoder.decodeSingularStringField(value: &coordinatesInputFeatureName)
            case 202: try try decoder.decodeSingularStringField(value: &iouThresholdInputFeatureName)
            case 203: try try decoder.decodeSingularStringField(value: &confidenceThresholdInputFeatureName)
            case 210: try try decoder.decodeSingularStringField(value: &confidenceOutputFeatureName)
            case 211: try try decoder.decodeSingularStringField(value: &coordinatesOutputFeatureName)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        try { if case let .pickTop(v)? = self.suppressionMethod {
        ...
        if iouThreshold != 0 {
            try visitor.visitSingularDoubleField(value: iouThreshold, fieldNumber: 110)
        }
        if confidenceThreshold != 0 {
            try visitor.visitSingularDoubleField(value: confidenceThreshold, fieldNumber: 111)
        }
        if !confidenceInputFeatureName.isEmpty {
            try visitor.visitSingularStringField(value: confidenceInputFeatureName, fieldNumber: 200)
        }
        if !coordinatesInputFeatureName.isEmpty {
            try visitor.visitSingularStringField(value: coordinatesInputFeatureName, fieldNumber: 201)
        }
        if !iouThresholdInputFeatureName.isEmpty {
            try visitor.visitSingularStringField(value: iouThresholdInputFeatureName, fieldNumber: 202)
        }
        if !confidenceThresholdInputFeatureName.isEmpty {
            try visitor.visitSingularStringField(value: confidenceThresholdInputFeatureName, fieldNumber: 203)
        }
        if !confidenceOutputFeatureName.isEmpty {
            try visitor.visitSingularStringField(value: confidenceOutputFeatureName, fieldNumber: 210)
        }
        if !coordinatesOutputFeatureName.isEmpty {
            try visitor.visitSingularStringField(value: coordinatesOutputFeatureName, fieldNumber: 211)
        }
...
extension CoreML_Specification_NonMaximumSuppression.PickTop: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularBoolField(value: &perClass)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if perClass != false {
            try visitor.visitSingularBoolField(value: perClass, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }

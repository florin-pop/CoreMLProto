...
public struct CoreML_Specification_CategoricalMapping {
    ...
    var mappingType: CoreML_Specification_CategoricalMapping.OneOf_MappingType?

    /// Conversion from strings to integers
    var stringToInt64Map: CoreML_Specification_StringToInt64Map {
        get {
            if case let .stringToInt64Map(v)? = mappingType { return v }
    ...
    var int64ToStringMap: CoreML_Specification_Int64ToStringMap {
        get {
            if case let .int64ToStringMap(v)? = mappingType { return v }
    ...
    var valueOnUnknown: CoreML_Specification_CategoricalMapping.OneOf_ValueOnUnknown?

    /// Default output when converting from an integer to a string.
    var strValue: String {
        get {
            if case let .strValue(v)? = valueOnUnknown { return v }
            return String()
        }
    ...
    var int64Value: Int64 {
        get {
            if case let .int64Value(v)? = valueOnUnknown { return v }
            return 0
        }
        ...
        case int64ToStringMap(CoreML_Specification_Int64ToStringMap)
            ...
            static func == (lhs: CoreML_Specification_CategoricalMapping.OneOf_MappingType, rhs: CoreML_Specification_CategoricalMapping.OneOf_MappingType) -> Bool {
                ...
                case (.stringToInt64Map, .stringToInt64Map): return {
                        guard case let .stringToInt64Map(l) = lhs, case let .stringToInt64Map(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.int64ToStringMap, .int64ToStringMap): return {
                        guard case let .int64ToStringMap(l) = lhs, case let .int64ToStringMap(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
        ...
        case int64Value(Int64)
            ...
            static func == (lhs: CoreML_Specification_CategoricalMapping.OneOf_ValueOnUnknown, rhs: CoreML_Specification_CategoricalMapping.OneOf_ValueOnUnknown) -> Bool {
                ...
                case (.strValue, .strValue): return {
                        guard case let .strValue(l) = lhs, case let .strValue(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
...
extension CoreML_Specification_CategoricalMapping: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 1: try {
                    ...
                    if let current = self.mappingType {
                        hadOneofValue = true
                        if case let .stringToInt64Map(m) = current { v = m }
                    }
            ...
            case 2: try {
                    ...
                    if let current = self.mappingType {
                        hadOneofValue = true
                        if case let .int64ToStringMap(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        case .stringToInt64Map?: try {
                guard case let .stringToInt64Map(v)? = self.mappingType else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 1)
            }()
        case .int64ToStringMap?: try {
                guard case let .int64ToStringMap(v)? = self.mappingType else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 2)
            }()
        case nil: break
        }
        switch valueOnUnknown {
        case .strValue?: try {
                guard case let .strValue(v)? = self.valueOnUnknown else { preconditionFailure() }
                try visitor.visitSingularStringField(value: v, fieldNumber: 101)
            }()
        case .int64Value?: try {
                guard case let .int64Value(v)? = self.valueOnUnknown else { preconditionFailure() }

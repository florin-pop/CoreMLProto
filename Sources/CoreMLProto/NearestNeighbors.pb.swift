...
public struct CoreML_Specification_KNearestNeighborsClassifier {
    ...
    mutating func clearNearestNeighborsIndex() { _nearestNeighborsIndex = nil }
    ...
    mutating func clearNumberOfNeighbors() { _numberOfNeighbors = nil }

    /// *
    /// Type of labels supported by the model. Currently supports String or Int64
    /// labels.
    var classLabels: CoreML_Specification_KNearestNeighborsClassifier.OneOf_ClassLabels?
    ...
    var defaultClassLabel: CoreML_Specification_KNearestNeighborsClassifier.OneOf_DefaultClassLabel?

    var defaultStringLabel: String {
        get {
            if case let .defaultStringLabel(v)? = defaultClassLabel { return v }
            return String()
        }
    ...
    var defaultInt64Label: Int64 {
        get {
            if case let .defaultInt64Label(v)? = defaultClassLabel { return v }
            return 0
        }
    ...
    /// new data point.
    var weightingScheme: CoreML_Specification_KNearestNeighborsClassifier.OneOf_WeightingScheme?

    var uniformWeighting: CoreML_Specification_UniformWeighting {
        get {
            if case let .uniformWeighting(v)? = weightingScheme { return v }
    ...
    var inverseDistanceWeighting: CoreML_Specification_InverseDistanceWeighting {
        get {
            if case let .inverseDistanceWeighting(v)? = weightingScheme { return v }
        ...
        case defaultInt64Label(Int64)
            ...
            static func == (lhs: CoreML_Specification_KNearestNeighborsClassifier.OneOf_DefaultClassLabel, rhs: CoreML_Specification_KNearestNeighborsClassifier.OneOf_DefaultClassLabel) -> Bool {
                ...
                case (.defaultStringLabel, .defaultStringLabel): return {
                        guard case let .defaultStringLabel(l) = lhs, case let .defaultStringLabel(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.defaultInt64Label, .defaultInt64Label): return {
                        guard case let .defaultInt64Label(l) = lhs, case let .defaultInt64Label(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                default: return false
                }
        ...
        case inverseDistanceWeighting(CoreML_Specification_InverseDistanceWeighting)
            ...
            static func == (lhs: CoreML_Specification_KNearestNeighborsClassifier.OneOf_WeightingScheme, rhs: CoreML_Specification_KNearestNeighborsClassifier.OneOf_WeightingScheme) -> Bool {
                ...
                case (.uniformWeighting, .uniformWeighting): return {
                        guard case let .uniformWeighting(l) = lhs, case let .uniformWeighting(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.inverseDistanceWeighting, .inverseDistanceWeighting): return {
                        guard case let .inverseDistanceWeighting(l) = lhs, case let .inverseDistanceWeighting(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                default: return false
                }
    ...
    fileprivate var _nearestNeighborsIndex: CoreML_Specification_NearestNeighborsIndex?
    fileprivate var _numberOfNeighbors: CoreML_Specification_Int64Parameter?
}
...
public struct CoreML_Specification_NearestNeighborsIndex {
    ...
    var indexType: CoreML_Specification_NearestNeighborsIndex.OneOf_IndexType?

    var linearIndex: CoreML_Specification_LinearIndex {
        get {
            if case let .linearIndex(v)? = indexType { return v }
    ...
    var singleKdTreeIndex: CoreML_Specification_SingleKdTreeIndex {
        get {
            if case let .singleKdTreeIndex(v)? = indexType { return v }
    ...
    var distanceFunction: CoreML_Specification_NearestNeighborsIndex.OneOf_DistanceFunction?

    var squaredEuclideanDistance: CoreML_Specification_SquaredEuclideanDistance {
        get {
            if case let .squaredEuclideanDistance(v)? = distanceFunction { return v }
        ...
        case singleKdTreeIndex(CoreML_Specification_SingleKdTreeIndex)
            ...
            static func == (lhs: CoreML_Specification_NearestNeighborsIndex.OneOf_IndexType, rhs: CoreML_Specification_NearestNeighborsIndex.OneOf_IndexType) -> Bool {
                ...
                case (.linearIndex, .linearIndex): return {
                        guard case let .linearIndex(l) = lhs, case let .linearIndex(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.singleKdTreeIndex, .singleKdTreeIndex): return {
                        guard case let .singleKdTreeIndex(l) = lhs, case let .singleKdTreeIndex(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                default: return false
                }
        ...
        case squaredEuclideanDistance(CoreML_Specification_SquaredEuclideanDistance)
            ...
            static func == (lhs: CoreML_Specification_NearestNeighborsIndex.OneOf_DistanceFunction, rhs: CoreML_Specification_NearestNeighborsIndex.OneOf_DistanceFunction) -> Bool {
                ...
                case (.squaredEuclideanDistance, .squaredEuclideanDistance): return {
                        guard case let .squaredEuclideanDistance(l) = lhs, case let .squaredEuclideanDistance(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                }
            }
...
extension CoreML_Specification_KNearestNeighborsClassifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularMessageField(value: &_nearestNeighborsIndex)
            case 3: try try decoder.decodeSingularMessageField(value: &_numberOfNeighbors)
            case 100: try {
            ...
            case 200: try {
                    ...
                    if let current = self.weightingScheme {
                        hadOneofValue = true
                        if case let .uniformWeighting(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 210: try {
                    ...
                    if let current = self.weightingScheme {
                        hadOneofValue = true
                        if case let .inverseDistanceWeighting(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        switch defaultClassLabel {
        case .defaultStringLabel?: try {
                guard case let .defaultStringLabel(v)? = self.defaultClassLabel else { preconditionFailure() }
                try visitor.visitSingularStringField(value: v, fieldNumber: 110)
            }()
        case .defaultInt64Label?: try {
                guard case let .defaultInt64Label(v)? = self.defaultClassLabel else { preconditionFailure() }
        ...
        case .uniformWeighting?: try {
                guard case let .uniformWeighting(v)? = self.weightingScheme else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 200)
            }()
        case .inverseDistanceWeighting?: try {
                guard case let .inverseDistanceWeighting(v)? = self.weightingScheme else { preconditionFailure() }
...
extension CoreML_Specification_NearestNeighborsIndex: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularInt32Field(value: &numberOfDimensions)
            case 2: try try decoder.decodeRepeatedMessageField(value: &floatSamples)
            case 100: try {
                    var v: CoreML_Specification_LinearIndex?
                    var hadOneofValue = false
                    if let current = self.indexType {
                        hadOneofValue = true
                        if case let .linearIndex(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 110: try {
                    ...
                    if let current = self.indexType {
                        hadOneofValue = true
                        if case let .singleKdTreeIndex(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 200: try {
                    ...
                    if let current = self.distanceFunction {
                        hadOneofValue = true
                        if case let .squaredEuclideanDistance(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if numberOfDimensions != 0 {
            try visitor.visitSingularInt32Field(value: numberOfDimensions, fieldNumber: 1)
        }
        if !floatSamples.isEmpty {
            try visitor.visitRepeatedMessageField(value: floatSamples, fieldNumber: 2)
        }
        switch indexType {
        case .linearIndex?: try {
                guard case let .linearIndex(v)? = self.indexType else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 100)
            }()
        case .singleKdTreeIndex?: try {
                guard case let .singleKdTreeIndex(v)? = self.indexType else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 110)
            }()
        case nil: break
        }
        try { if case let .squaredEuclideanDistance(v)? = self.distanceFunction {
            try visitor.visitSingularMessageField(value: v, fieldNumber: 200)
        } }()
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_SingleKdTreeIndex: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularInt32Field(value: &leafSize)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if leafSize != 0 {
            try visitor.visitSingularInt32Field(value: leafSize, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }

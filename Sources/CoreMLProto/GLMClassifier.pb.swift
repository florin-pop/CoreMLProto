...
public struct CoreML_Specification_GLMClassifier {
    ...
    var classLabels: CoreML_Specification_GLMClassifier.OneOf_ClassLabels?
...
extension CoreML_Specification_GLMClassifier: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &weights)
            case 2: try try decoder.decodeRepeatedDoubleField(value: &offset)
            case 3: try try decoder.decodeSingularEnumField(value: &postEvaluationTransform)
            case 4: try try decoder.decodeSingularEnumField(value: &classEncoding)
            case 100: try {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if !weights.isEmpty {
            try visitor.visitRepeatedMessageField(value: weights, fieldNumber: 1)
        }
        if !offset.isEmpty {
            try visitor.visitPackedDoubleField(value: offset, fieldNumber: 2)
        }
        if postEvaluationTransform != .logit {
            try visitor.visitSingularEnumField(value: postEvaluationTransform, fieldNumber: 3)
        }
        if classEncoding != .referenceClass {
            try visitor.visitSingularEnumField(value: classEncoding, fieldNumber: 4)
        }
        switch classLabels {
...
extension CoreML_Specification_GLMClassifier.DoubleArray: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedDoubleField(value: &value)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !value.isEmpty {
            try visitor.visitPackedDoubleField(value: value, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }

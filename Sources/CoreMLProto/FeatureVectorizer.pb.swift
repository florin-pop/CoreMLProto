...
extension CoreML_Specification_FeatureVectorizer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            switch fieldNumber {
            case 1: try try decoder.decodeRepeatedMessageField(value: &inputList)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !inputList.isEmpty {
            try visitor.visitRepeatedMessageField(value: inputList, fieldNumber: 1)
        }
...
extension CoreML_Specification_FeatureVectorizer.InputColumn: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularStringField(value: &inputColumn)
            case 2: try try decoder.decodeSingularUInt64Field(value: &inputDimensions)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !inputColumn.isEmpty {
            try visitor.visitSingularStringField(value: inputColumn, fieldNumber: 1)
        }
        if inputDimensions != 0 {
            try visitor.visitSingularUInt64Field(value: inputDimensions, fieldNumber: 2)
        }
        try unknownFields.traverse(visitor: &visitor)
    }

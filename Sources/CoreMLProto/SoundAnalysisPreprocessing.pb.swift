...
public struct CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing {
  ...
  /// Vision feature print type
  public enum OneOf_SoundAnalysisPreprocessingType: Equatable {
    case vggish(CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.Vggish)

  #if !swift(>=4.1)
    public static func ==(lhs: CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.OneOf_SoundAnalysisPreprocessingType, rhs: CoreML_Specification_CoreMLModels_SoundAnalysisPreprocessing.OneOf_SoundAnalysisPreprocessingType) -> Bool {

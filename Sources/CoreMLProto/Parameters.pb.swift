...
public struct CoreML_Specification_Int64Parameter {
    ...
    var allowedValues: CoreML_Specification_Int64Parameter.OneOf_AllowedValues?

    var range: CoreML_Specification_Int64Range {
        get {
            if case let .range(v)? = allowedValues { return v }
    ...
    var set: CoreML_Specification_Int64Set {
        get {
            if case let .set(v)? = allowedValues { return v }
        ...
        case set(CoreML_Specification_Int64Set)
            ...
            static func == (lhs: CoreML_Specification_Int64Parameter.OneOf_AllowedValues, rhs: CoreML_Specification_Int64Parameter.OneOf_AllowedValues) -> Bool {
                ...
                case (.range, .range): return {
                        guard case let .range(l) = lhs, case let .range(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.set, .set): return {
                        guard case let .set(l) = lhs, case let .set(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
...
public struct CoreML_Specification_DoubleParameter {
    ...
    var allowedValues: CoreML_Specification_DoubleParameter.OneOf_AllowedValues?
...
extension CoreML_Specification_Int64Parameter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularInt64Field(value: &defaultValue)
            case 10: try {
                    var v: CoreML_Specification_Int64Range?
                    var hadOneofValue = false
                    if let current = self.allowedValues {
                        hadOneofValue = true
                        if case let .range(m) = current { v = m }
                    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        if defaultValue != 0 {
            try visitor.visitSingularInt64Field(value: defaultValue, fieldNumber: 1)
        }
        switch allowedValues {
        case .range?: try {
                guard case let .range(v)? = self.allowedValues else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
            }()
        case .set?: try {
                guard case let .set(v)? = self.allowedValues else { preconditionFailure() }
...
extension CoreML_Specification_DoubleParameter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularDoubleField(value: &defaultValue)
            case 10: try {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        // https://github.com/apple/swift-protobuf/issues/1182
        if defaultValue != 0 {
            try visitor.visitSingularDoubleField(value: defaultValue, fieldNumber: 1)
        }
        try { if case let .range(v)? = self.allowedValues {
            try visitor.visitSingularMessageField(value: v, fieldNumber: 10)
        } }()
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_StringParameter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularStringField(value: &defaultValue)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !defaultValue.isEmpty {
            try visitor.visitSingularStringField(value: defaultValue, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }
...
extension CoreML_Specification_BoolParameter: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularBoolField(value: &defaultValue)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if defaultValue != false {
            try visitor.visitSingularBoolField(value: defaultValue, fieldNumber: 1)
        }
        try unknownFields.traverse(visitor: &visitor)
    }

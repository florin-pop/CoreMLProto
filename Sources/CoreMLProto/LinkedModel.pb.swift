...
public struct CoreML_Specification_LinkedModel {
    ...
    var linkType: CoreML_Specification_LinkedModel.OneOf_LinkType?

    /// A model located via a file system path
    var linkedModelFile: CoreML_Specification_LinkedModelFile {
        get {
            if case let .linkedModelFile(v)? = linkType { return v }
        ...
        case linkedModelFile(CoreML_Specification_LinkedModelFile)
            ...
            static func == (lhs: CoreML_Specification_LinkedModel.OneOf_LinkType, rhs: CoreML_Specification_LinkedModel.OneOf_LinkType) -> Bool {
                ...
                case (.linkedModelFile, .linkedModelFile): return {
                        guard case let .linkedModelFile(l) = lhs, case let .linkedModelFile(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                }
            }
...
public struct CoreML_Specification_LinkedModelFile {
    ...
    mutating func clearLinkedModelFileName() { _linkedModelFileName = nil }
    ...
    mutating func clearLinkedModelSearchPath() { _linkedModelSearchPath = nil }

    var unknownFields = SwiftProtobuf.UnknownStorage()

    init() {}

    fileprivate var _linkedModelFileName: CoreML_Specification_StringParameter?
    fileprivate var _linkedModelSearchPath: CoreML_Specification_StringParameter?
}
...
extension CoreML_Specification_LinkedModel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 1: try {
                    ...
                    if let current = self.linkType {
                        hadOneofValue = true
                        if case let .linkedModelFile(m) = current { v = m }
                    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        try { if case let .linkedModelFile(v)? = self.linkType {
...
extension CoreML_Specification_LinkedModelFile: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 1: try try decoder.decodeSingularMessageField(value: &_linkedModelFileName)
            case 2: try try decoder.decodeSingularMessageField(value: &_linkedModelSearchPath)
            default: break
            }
        }
    }

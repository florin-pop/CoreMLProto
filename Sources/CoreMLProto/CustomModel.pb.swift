...
public struct CoreML_Specification_CustomModel {
    ...
    var className: String = .init()

    var parameters: [String: CoreML_Specification_CustomModel.CustomModelParamValue] = [:]
    ...
    struct CustomModelParamValue {
        ...
        var value: CoreML_Specification_CustomModel.CustomModelParamValue.OneOf_Value?

        var doubleValue: Double {
            get {
                if case let .doubleValue(v)? = value { return v }
                return 0
            }
        ...
        var stringValue: String {
            get {
                if case let .stringValue(v)? = value { return v }
                return String()
            }
        ...
        var intValue: Int32 {
            get {
                if case let .intValue(v)? = value { return v }
                return 0
            }
        ...
        var longValue: Int64 {
            get {
                if case let .longValue(v)? = value { return v }
                return 0
            }
        ...
        var boolValue: Bool {
            get {
                if case let .boolValue(v)? = value { return v }
                return false
            }
        ...
        var bytesValue: Data {
            get {
                if case let .bytesValue(v)? = value { return v }
                return Data()
            }
            ...
            case bytesValue(Data)
                ...
                static func == (lhs: CoreML_Specification_CustomModel.CustomModelParamValue.OneOf_Value, rhs: CoreML_Specification_CustomModel.CustomModelParamValue.OneOf_Value) -> Bool {
                    ...
                    case (.intValue, .intValue): return {
                            guard case let .intValue(l) = lhs, case let .intValue(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
                    case (.longValue, .longValue): return {
                            guard case let .longValue(l) = lhs, case let .longValue(r) = rhs else { preconditionFailure() }
                            return l == r
                        }()
...
extension CoreML_Specification_CustomModel: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            // enabled. https://github.com/apple/swift-protobuf/issues/1034
            switch fieldNumber {
            case 10: try try decoder.decodeSingularStringField(value: &className)
            ...
            case 40: try try decoder.decodeSingularStringField(value: &description_p)
            default: break
            }
        }
    }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        if !className.isEmpty {
            try visitor.visitSingularStringField(value: className, fieldNumber: 10)
        }
        if !parameters.isEmpty {
            try visitor.visitMapField(fieldType: SwiftProtobuf._ProtobufMessageMap<SwiftProtobuf.ProtobufString, CoreML_Specification_CustomModel.CustomModelParamValue>.self, value: parameters, fieldNumber: 30)
        }
        if !description_p.isEmpty {
            try visitor.visitSingularStringField(value: description_p, fieldNumber: 40)
        }
...
extension CoreML_Specification_CustomModel.CustomModelParamValue: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        case .doubleValue?: try {
                guard case let .doubleValue(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularDoubleField(value: v, fieldNumber: 10)
            }()
        case .stringValue?: try {
                guard case let .stringValue(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularStringField(value: v, fieldNumber: 20)
            }()
        case .intValue?: try {
                guard case let .intValue(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularInt32Field(value: v, fieldNumber: 30)
            }()
        case .longValue?: try {
                guard case let .longValue(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularInt64Field(value: v, fieldNumber: 40)
            }()
        case .boolValue?: try {
                guard case let .boolValue(v)? = self.value else { preconditionFailure() }
                try visitor.visitSingularBoolField(value: v, fieldNumber: 50)
            }()
        case .bytesValue?: try {
                guard case let .bytesValue(v)? = self.value else { preconditionFailure() }

...
public struct CoreML_Specification_Imputer {
    ...
    var imputedValue: CoreML_Specification_Imputer.OneOf_ImputedValue?

    var imputedDoubleValue: Double {
        get {
            if case let .imputedDoubleValue(v)? = imputedValue { return v }
            return 0
        }
    ...
    var imputedInt64Value: Int64 {
        get {
            if case let .imputedInt64Value(v)? = imputedValue { return v }
            return 0
        }
    ...
    var imputedStringValue: String {
        get {
            if case let .imputedStringValue(v)? = imputedValue { return v }
            return String()
        }
    ...
    var imputedDoubleArray: CoreML_Specification_DoubleVector {
        get {
            if case let .imputedDoubleArray(v)? = imputedValue { return v }
    ...
    var imputedInt64Array: CoreML_Specification_Int64Vector {
        get {
            if case let .imputedInt64Array(v)? = imputedValue { return v }
    ...
    var imputedStringDictionary: CoreML_Specification_StringToDoubleMap {
        get {
            if case let .imputedStringDictionary(v)? = imputedValue { return v }
    ...
    var imputedInt64Dictionary: CoreML_Specification_Int64ToDoubleMap {
        get {
            if case let .imputedInt64Dictionary(v)? = imputedValue { return v }
            return CoreML_Specification_Int64ToDoubleMap()
        }
        set { imputedValue = .imputedInt64Dictionary(newValue) }
    }

    var replaceValue: CoreML_Specification_Imputer.OneOf_ReplaceValue?

    var replaceDoubleValue: Double {
        get {
            if case let .replaceDoubleValue(v)? = replaceValue { return v }
            return 0
        }
    ...
    var replaceInt64Value: Int64 {
        get {
            if case let .replaceInt64Value(v)? = replaceValue { return v }
            return 0
        }
    ...
    var replaceStringValue: String {
        get {
            if case let .replaceStringValue(v)? = replaceValue { return v }
            return String()
        }
        ...
        case imputedInt64Dictionary(CoreML_Specification_Int64ToDoubleMap)
            ...
            static func == (lhs: CoreML_Specification_Imputer.OneOf_ImputedValue, rhs: CoreML_Specification_Imputer.OneOf_ImputedValue) -> Bool {
                ...
                case (.imputedDoubleValue, .imputedDoubleValue): return {
                        guard case let .imputedDoubleValue(l) = lhs, case let .imputedDoubleValue(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.imputedInt64Value, .imputedInt64Value): return {
                        guard case let .imputedInt64Value(l) = lhs, case let .imputedInt64Value(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.imputedStringValue, .imputedStringValue): return {
                        guard case let .imputedStringValue(l) = lhs, case let .imputedStringValue(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.imputedDoubleArray, .imputedDoubleArray): return {
                        guard case let .imputedDoubleArray(l) = lhs, case let .imputedDoubleArray(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.imputedInt64Array, .imputedInt64Array): return {
                        guard case let .imputedInt64Array(l) = lhs, case let .imputedInt64Array(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.imputedStringDictionary, .imputedStringDictionary): return {
                        guard case let .imputedStringDictionary(l) = lhs, case let .imputedStringDictionary(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.imputedInt64Dictionary, .imputedInt64Dictionary): return {
                        guard case let .imputedInt64Dictionary(l) = lhs, case let .imputedInt64Dictionary(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
        ...
        case replaceStringValue(String)
            ...
            static func == (lhs: CoreML_Specification_Imputer.OneOf_ReplaceValue, rhs: CoreML_Specification_Imputer.OneOf_ReplaceValue) -> Bool {
                ...
                case (.replaceDoubleValue, .replaceDoubleValue): return {
                        guard case let .replaceDoubleValue(l) = lhs, case let .replaceDoubleValue(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.replaceInt64Value, .replaceInt64Value): return {
                        guard case let .replaceInt64Value(l) = lhs, case let .replaceInt64Value(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                case (.replaceStringValue, .replaceStringValue): return {
                        guard case let .replaceStringValue(l) = lhs, case let .replaceStringValue(r) = rhs else { preconditionFailure() }
                        return l == r
                    }()
                default: return false
                }
...
extension CoreML_Specification_Imputer: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
        ...
        while let fieldNumber = try decoder.nextFieldNumber() {
            ...
            case 4: try {
                    ...
                    if let current = self.imputedValue {
                        hadOneofValue = true
                        if case let .imputedDoubleArray(m) = current { v = m }
                    }
            ...
            case 5: try {
                    ...
                    if let current = self.imputedValue {
                        hadOneofValue = true
                        if case let .imputedInt64Array(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 6: try {
                    ...
                    if let current = self.imputedValue {
                        hadOneofValue = true
                        if case let .imputedStringDictionary(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
            ...
            case 7: try {
                    ...
                    if let current = self.imputedValue {
                        hadOneofValue = true
                        if case let .imputedInt64Dictionary(m) = current { v = m }
                    }
                    try decoder.decodeSingularMessageField(value: &v)
                    if let v = v {
                        if hadOneofValue { try decoder.handleConflictingOneOf() }
    ...
    func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
        ...
        case .imputedDoubleValue?: try {
                guard case let .imputedDoubleValue(v)? = self.imputedValue else { preconditionFailure() }
                try visitor.visitSingularDoubleField(value: v, fieldNumber: 1)
            }()
        case .imputedInt64Value?: try {
                guard case let .imputedInt64Value(v)? = self.imputedValue else { preconditionFailure() }
                try visitor.visitSingularInt64Field(value: v, fieldNumber: 2)
            }()
        case .imputedStringValue?: try {
                guard case let .imputedStringValue(v)? = self.imputedValue else { preconditionFailure() }
                try visitor.visitSingularStringField(value: v, fieldNumber: 3)
            }()
        case .imputedDoubleArray?: try {
                guard case let .imputedDoubleArray(v)? = self.imputedValue else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 4)
            }()
        case .imputedInt64Array?: try {
                guard case let .imputedInt64Array(v)? = self.imputedValue else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 5)
            }()
        case .imputedStringDictionary?: try {
                guard case let .imputedStringDictionary(v)? = self.imputedValue else { preconditionFailure() }
                try visitor.visitSingularMessageField(value: v, fieldNumber: 6)
            }()
        case .imputedInt64Dictionary?: try {
                guard case let .imputedInt64Dictionary(v)? = self.imputedValue else { preconditionFailure() }
        ...
        case .replaceDoubleValue?: try {
                guard case let .replaceDoubleValue(v)? = self.replaceValue else { preconditionFailure() }
                try visitor.visitSingularDoubleField(value: v, fieldNumber: 11)
            }()
        case .replaceInt64Value?: try {
                guard case let .replaceInt64Value(v)? = self.replaceValue else { preconditionFailure() }
                try visitor.visitSingularInt64Field(value: v, fieldNumber: 12)
            }()
        case .replaceStringValue?: try {
                guard case let .replaceStringValue(v)? = self.replaceValue else { preconditionFailure() }
